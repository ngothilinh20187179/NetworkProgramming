// AsyncSelectServer
// ChatServer
// Đăng nhập theo cú pháp client_id: xxx
// nếu đăng nhập đúng mới được gửi nhận dữ liệu
#include "framework.h"
#include "Server3.h"
#include <stdio.h>
#include <winsock2.h>
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SERVER3, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SERVER3));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SERVER3));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_SERVER3);
...
//
//
BOOL DangNhap(SOCKET client, char* buf)
{
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SOCKET:
    {
        ...
        if (WSAGETSELECTEVENT(lParam) == FD_ACCEPT)
        {
            ...
            const char* msg = "Hello client. Nhap ten dung cu phap sau 'client_id: xxxx':\n";
            send(client, msg, strlen(msg), 0);
